    ...
    return(
        <div className=" w-[96%] h-[45%] mt-4 rounded-xl border-2 border-slate-500 bg-slate-700 " >
            ...
            <div className="flex mb-4">
                <h1 className="w-[85%] text-xl text-white text-right"> {information.name}</h1>
                <h1 className="w-[15%] text-xl text-slate-400 pr-3  text-right">: نام</h1>
            </div>
            
            <div className="flex mb-4">
                <h1 className="w-[68%] text-xl text-white text-right"> {information.lastname}</h1>
                <h1 className="w-[32%] text-xl text-slate-400 pr-3  text-right">  :نام خانوادگی</h1>
            </div>
            
            <div className="flex mb-4">
                <h1 className="w-[75%]  text-white text-xl text-right"> {information.nationalcode} </h1>
                <h1 className="w-[25%] text-xl  text-slate-400 pr-3  text-right"> : کد ملی</h1>
            </div>
            
            <div className="flex mb-4">
                <h1 className="w-[65%] text-xl text-white text-right"> {information.cardnumber} </h1>
                <h1 className="w-[35%] text-xl text-slate-400 pr-3  text-right">:  شماره حساب</h1>
            </div>
            
            <div className="flex mb-4">
                <h1 className="w-[68%] text-xl text-white text-right">{information.balance}</h1>
            ...
            <div className="flex mb-4">
                    ...
                    {information.isAdmin ? (<h1 className="w-[80%] text-xl text-white text-right"> ادمین </h1> ) :
